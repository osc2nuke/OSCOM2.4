<?php
	...
	*/
	...
	class sb_twitter {
		...
		function sb_twitter() {
			global $osC_Language;
			$this->title = $osC_Language->get('MODULE_SOCIAL_BOOKMARKS_TWITTER_TITLE');
			$this->public_title = $osC_Language->get('MODULE_SOCIAL_BOOKMARKS_TWITTER_PUBLIC_TITLE');
			$this->description = $osC_Language->get('MODULE_SOCIAL_BOOKMARKS_TWITTER_DESCRIPTION');
