<?php
	...
	*/
	...
	class sb_digg {
		...
		function sb_digg() {
			global $osC_Language+
			$this->title = $osC_Language->get('MODULE_SOCIAL_BOOKMARKS_DIGG_TITLE');
			$this->public_title = $osC_Language->get('MODULE_SOCIAL_BOOKMARKS_DIGG_PUBLIC_TITLE');
			$this->description = $osC_Language->get('MODULE_SOCIAL_BOOKMARKS_DIGG_DESCRIPTION');
