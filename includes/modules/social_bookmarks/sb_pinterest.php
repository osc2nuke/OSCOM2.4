	...
	*/
	...
	class sb_pinterest {
		...
		function sb_pinterest() {
			global $osC_Language;
			$this->title = $osC_Language->get('MODULE_SOCIAL_BOOKMARKS_PINTEREST_TITLE');
			$this->public_title = $osC_Language->get('MODULE_SOCIAL_BOOKMARKS_PINTEREST_PUBLIC_TITLE');
			$this->description = $osC_Language->get('MODULE_SOCIAL_BOOKMARKS_PINTEREST_DESCRIPTION');
