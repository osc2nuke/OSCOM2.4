	...
	*/
	...
	class sb_twitter_button {
		...
		function sb_twitter_button() {
			global $osC_Language;
			$this->title = $osC_Language->get('MODULE_SOCIAL_BOOKMARKS_TWITTER_BUTTON_TITLE');
			$this->public_title = $osC_Language->get('MODULE_SOCIAL_BOOKMARKS_TWITTER_BUTTON_PUBLIC_TITLE');
			$this->description = $osC_Language->get('MODULE_SOCIAL_BOOKMARKS_TWITTER_BUTTON_DESCRIPTION');
