	...
	*/
	...
	class sb_facebook_like {
		...
		function sb_facebook_like() {
			global $osC_Language;
			$this->title = $osC_Language->get('MODULE_SOCIAL_BOOKMARKS_FACEBOOK_LIKE_TITLE');
			$this->public_title = $osC_Language->get('MODULE_SOCIAL_BOOKMARKS_FACEBOOK_LIKE_PUBLIC_TITLE');
			$this->description = $osC_Language->get('MODULE_SOCIAL_BOOKMARKS_FACEBOOK_LIKE_DESCRIPTION');
