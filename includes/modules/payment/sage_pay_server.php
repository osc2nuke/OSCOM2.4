	...
	*/
	...
	class sage_pay_server {
		...
		function sage_pay_server() {
			global $PHP_SELF, $order $osC_Language;
			
			$this->signature = 'sage_pay|sage_pay_server|2.1|2.3';
			$this->api_version = '3.00';
			
			$this->code = 'sage_pay_server';
			$this->title = $osC_Language->get('MODULE_PAYMENT_SAGE_PAY_SERVER_TEXT_TITLE');
			$this->public_title = $osC_Language->get('MODULE_PAYMENT_SAGE_PAY_SERVER_TEXT_PUBLIC_TITLE');
			$this->description = $osC_Language->get('MODULE_PAYMENT_SAGE_PAY_SERVER_TEXT_DESCRIPTION');
			...
			if ( !function_exists('curl_init') ) {
				$this->description = '<div class="secWarning">' . $osC_Language->get('MODULE_PAYMENT_SAGE_PAY_SERVER_ERROR_ADMIN_CURL') . '</div>' . $this->description;
			...
			if ( $this->enabled === true ) {
				if ( !tep_not_null(MODULE_PAYMENT_SAGE_PAY_SERVER_VENDOR_LOGIN_NAME) ) {
					$this->description = '<div class="secWarning">' . $osC_Language->get('MODULE_PAYMENT_SAGE_PAY_SERVER_ERROR_ADMIN_CONFIGURATION') . '</div>' . $this->description;
		...
		function get_error() {
			...
			if ( isset($error_number) ) {
				...
				$message = $this->getErrorMessage($error_number) . ' ' . $osC_Language->get('MODULE_PAYMENT_SAGE_PAY_SERVER_ERROR_GENERAL');
			}
			
			$error = array('title' => $osC_Language->get('MODULE_PAYMENT_SAGE_PAY_SERVER_ERROR_TITLE'),
			'error' => $message);
...
EOD;
		...
		global $osC_Language;
			$dialog_title = $osC_Language->get('MODULE_PAYMENT_SAGE_PAY_SERVER_DIALOG_CONNECTION_TITLE');
			$dialog_button_close = $osC_Language->get('MODULE_PAYMENT_SAGE_PAY_SERVER_DIALOG_CONNECTION_BUTTON_CLOSE');
			$dialog_success = $osC_Language->get('MODULE_PAYMENT_SAGE_PAY_SERVER_DIALOG_CONNECTION_SUCCESS');
			$dialog_failed = $osC_Language->get('MODULE_PAYMENT_SAGE_PAY_SERVER_DIALOG_CONNECTION_FAILED');
			$dialog_error = $osC_Language->get('MODULE_PAYMENT_SAGE_PAY_SERVER_DIALOG_CONNECTION_ERROR');
			$dialog_connection_time = $osC_Language->get('MODULE_PAYMENT_SAGE_PAY_SERVER_DIALOG_CONNECTION_TIME');
...
EOD;
			...
			$info = '<p><img src="images/icons/locked.gif" border="0">&nbsp;<a href="javascript:openTestConnectionDialog();" style="text-decoration: underline; font-weight: bold;">' . $osC_Language->get('MODULE_PAYMENT_SAGE_PAY_SERVER_DIALOG_CONNECTION_LINK_TITLE') . '</a></p>' .
			...
			$info .= '</p><div id="testConnectionDialogProgress"><p>' . $osC_Language->get('MODULE_PAYMENT_SAGE_PAY_SERVER_DIALOG_CONNECTION_GENERAL_TEXT') . '</p><div id="tcdprogressbar"></div></div></div>' .
			$js;
