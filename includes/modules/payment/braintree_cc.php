<?php
	...
	*/
	...
	class braintree_cc {
		var $code, $title, $description, $enabled, $osC_Language;
		...
		function braintree_cc() {
			...
			$this->title = $osC_Language->get('MODULE_PAYMENT_BRAINTREE_CC_TEXT_TITLE');
			$this->public_title =$osC_Language->get(' MODULE_PAYMENT_BRAINTREE_CC_TEXT_PUBLIC_TITLE');
			$this->description = $osC_Language->get('MODULE_PAYMENT_BRAINTREE_CC_TEXT_DESCRIPTION');
