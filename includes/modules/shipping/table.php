<?php
	...
	*/
	...
	class table {
		...
		// class constructor
		function table() {
			global $order, $osC_Language;
			
			$OSCOM_Db = Registry::get('Db');
			
			$this->code = 'table';
			$this->title = $osC_Language->get('MODULE_SHIPPING_TABLE_TEXT_TITLE');
			$this->description = $osC_Language->get('MODULE_SHIPPING_TABLE_TEXT_DESCRIPTION');
		...
		function quote($method = '') {
			...
			'module' => $osC_Language->get('MODULE_SHIPPING_TABLE_TEXT_TITLE'),
