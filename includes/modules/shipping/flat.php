	...
	*/
	...
	class flat {
		...
		function flat() {
			...
			$this->code = 'flat';
			$this->title = $osC_Language->get('MODULE_SHIPPING_FLAT_TEXT_TITLE');
			$this->description = $osC_Language->get('MODULE_SHIPPING_FLAT_TEXT_DESCRIPTION');
		...
		function quote($method = '') {
			...
			'module' => $osC_Language->get('MODULE_SHIPPING_FLAT_TEXT_TITLE'),
			'methods' => array(array('id' => $this->code,
			'title' => $osC_Language->get('MODULE_SHIPPING_FLAT_TEXT_WAY'),
