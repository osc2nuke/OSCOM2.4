	...
	*/
	...
	class item {
		...
		function item() {
			...
			$this->code = 'item';
			$this->title = $osC_Language->get('MODULE_SHIPPING_ITEM_TEXT_TITLE');
			$this->description = $osC_Language->get('MODULE_SHIPPING_ITEM_TEXT_DESCRIPTION');
		...
		function quote($method = '') {
			...
			'module' => $osC_Language->get('MODULE_SHIPPING_ITEM_TEXT_TITLE'),
			'methods' => array(array('id' => $this->code,
			'title' => $osC_Language->get('MODULE_SHIPPING_ITEM_TEXT_WAY'),
