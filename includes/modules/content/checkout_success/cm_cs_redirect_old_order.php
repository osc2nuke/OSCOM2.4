	...
	*/
	...
	class cm_cs_redirect_old_order {
		...
		function cm_cs_redirect_old_order() {
			...
			$this->title = $osC_Language->get('MODULE_CONTENT_CHECKOUT_SUCCESS_REDIRECT_OLD_ORDER_TITLE');
			$this->description = $osC_Language->get('MODULE_CONTENT_CHECKOUT_SUCCESS_REDIRECT_OLD_ORDER_DESCRIPTION');
