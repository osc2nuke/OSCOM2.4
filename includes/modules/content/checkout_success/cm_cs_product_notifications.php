	...
	*/
	...
	class cm_cs_product_notifications {
		...
		function cm_cs_product_notifications() {
			...
			$this->title = $osC_Language->get('MODULE_CONTENT_CHECKOUT_SUCCESS_PRODUCT_NOTIFICATIONS_TITLE');
			$this->description = $osC_Language->get('MODULE_CONTENT_CHECKOUT_SUCCESS_PRODUCT_NOTIFICATIONS_DESCRIPTION');
		...
		function execute() {
			global $order_id, $osC_Language, $oscTemplate;
