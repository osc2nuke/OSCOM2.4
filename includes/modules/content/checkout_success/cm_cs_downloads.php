	...
	*/
	...
	class cm_cs_downloads {
		...
		function cm_cs_downloads() {
			...
			$this->title = $osC_Language->get('MODULE_CONTENT_CHECKOUT_SUCCESS_DOWNLOADS_TITLE');
			$this->description = $osC_Language->get('MODULE_CONTENT_CHECKOUT_SUCCESS_DOWNLOADS_DESCRIPTION');
