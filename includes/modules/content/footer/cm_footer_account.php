	...
	*/
	...
	class cm_footer_account {
		...
		function cm_footer_account() {
			...
			$this->title = $osC_Language->get('MODULE_CONTENT_FOOTER_ACCOUNT_TITLE');
			$this->description = $osC_Language->get('MODULE_CONTENT_FOOTER_ACCOUNT_DESCRIPTION');
		...
		function execute() {
			...
			if ( isset($_SESSION['customer_id']) ) {
				$account_content = '<li><a href="' . OSCOM::link('account.php', '', 'SSL') . '">' . $osC_Language->get('MODULE_CONTENT_FOOTER_ACCOUNT_BOX_ACCOUNT') . '</a></li>' .
				'<li><a href="' . OSCOM::link('address_book.php', '', 'SSL') . '">' . $osC_Language->get('MODULE_CONTENT_FOOTER_ACCOUNT_BOX_ADDRESS_BOOK') . '</a></li>' .
				'<li><a href="' . OSCOM::link('account_history.php', '', 'SSL') . '">' . $osC_Language->get('MODULE_CONTENT_FOOTER_ACCOUNT_BOX_ORDER_HISTORY') . '</a></li>' .
				'<li><br><a class="btn btn-danger btn-sm btn-block" role="button" href="' . OSCOM::link('logoff.php', '', 'SSL') . '"><i class="glyphicon glyphicon-log-out"></i> ' . $osC_Language->get('MODULE_CONTENT_FOOTER_ACCOUNT_BOX_LOGOFF') . '</a></li>';
			}
			else {
				$account_content = '<li><a href="' . OSCOM::link('create_account.php', '', 'SSL') . '">' . $osC_Language->get('MODULE_CONTENT_FOOTER_ACCOUNT_BOX_CREATE_ACCOUNT') . '</a></li>' .
				'<li><br><a class="btn btn-success btn-sm btn-block" role="button" href="' . OSCOM::link('login.php', '', 'SSL') . '"><i class="glyphicon glyphicon-log-in"></i> ' . $osC_Language->get('MODULE_CONTENT_FOOTER_ACCOUNT_BOX_LOGIN') . '</a></li>';
			}
