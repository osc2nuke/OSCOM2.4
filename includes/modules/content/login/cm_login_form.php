	...
	*/
	...
	class cm_login_form {
		...
		function cm_login_form() {
			...
			$this->title = $osC_Language->get('MODULE_CONTENT_LOGIN_FORM_TITLE');
			$this->description = $osC_Language->get('MODULE_CONTENT_LOGIN_FORM_DESCRIPTION');
		...
		function execute() {
			global $login_customer_id, $messageStack, $osC_Language, $oscTemplate;
			...
			if ($error == true) {
				$messageStack->add('login', $osC_Language->get('MODULE_CONTENT_LOGIN_TEXT_LOGIN_ERROR'));
			}
