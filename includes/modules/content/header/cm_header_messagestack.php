	...
	*/
	...
	class cm_header_messagestack {
		...
		function cm_header_messagestack() {
			...
			$this->title = $osC_Language->get('MODULE_CONTENT_HEADER_MESSAGESTACK_TITLE');
			$this->description = $osC_Language->get('MODULE_CONTENT_HEADER_MESSAGESTACK_DESCRIPTION');
		...
		function execute() {
			global $messageStack, $osC_Language, $oscTemplate;
