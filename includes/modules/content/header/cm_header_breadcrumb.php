	...
	*/
	...
	class cm_header_breadcrumb {
		...
		function cm_header_breadcrumb() {
			...
			$this->title = $osC_Language->get('MODULE_CONTENT_HEADER_BREADCRUMB_TITLE');
			$this->description = $osC_Language->get('MODULE_CONTENT_HEADER_BREADCRUMB_DESCRIPTION');
		...
		function execute() {
			global $breadcrumb, $osC_Language, $oscTemplate;
