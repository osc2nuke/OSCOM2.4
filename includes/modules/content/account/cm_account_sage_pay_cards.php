	...
	*/
	...
	class cm_account_sage_pay_cards {
		...
		function cm_account_sage_pay_cards() {
			...
			$this->title = $osC_Language->get('MODULE_CONTENT_ACCOUNT_SAGE_PAY_CARDS_TITLE');
			$this->description = $osC_Language->get('MODULE_CONTENT_ACCOUNT_SAGE_PAY_CARDS_DESCRIPTION');
			...
			$this->public_title = $osC_Language->get('MODULE_CONTENT_ACCOUNT_SAGE_PAY_CARDS_LINK_TITLE');
			...
			if ( $sage_pay_enabled !== true ) {
				...
				$this->description = '<div class="secWarning">' . $osC_Language->get('MODULE_CONTENT_ACCOUNT_SAGE_PAY_CARDS_ERROR_MAIN_MODULE') . '</div>' . $this->description;
			}
		}
