	...
	*/
	...
	class cm_account_braintree_cards {
		...
		function cm_account_braintree_cards() {
			...
			$this->title = $osC_Language->get('MODULE_CONTENT_ACCOUNT_BRAINTREE_CARDS_TITLE');
			$this->description = $osC_Language->get('MODULE_CONTENT_ACCOUNT_BRAINTREE_CARDS_DESCRIPTION');
			...
			$this->public_title = $osC_Language->get('MODULE_CONTENT_ACCOUNT_BRAINTREE_CARDS_LINK_TITLE');
			...
			if ( $braintree_enabled !== true ) {
				...
				$this->description = '<div class="secWarning">' . $osC_Language->get('MODULE_CONTENT_ACCOUNT_BRAINTREE_CARDS_ERROR_MAIN_MODULE') . '</div>' . $this->description;
			}
		}
