	...
	*/
	...
	class cm_account_set_password {
		...
		global $osC_Language;
			...
			$this->title = $osC_Language->get('MODULE_CONTENT_ACCOUNT_SET_PASSWORD_TITLE');
			$this->description = $osC_Language->get('MODULE_CONTENT_ACCOUNT_SET_PASSWORD_DESCRIPTION');
			...
			if ( isset($_SESSION['customer_id']) ) {
				...
				if ( empty($Qcheck->value('customers_password')) ) {
					...
					if ( MODULE_CONTENT_ACCOUNT_SET_PASSWORD_ALLOW_PASSWORD == 'True' ) {
						$oscTemplate->_data['account']['account']['links'] += array('set_password' => array('title' => $osC_Language->get('MODULE_CONTENT_ACCOUNT_SET_PASSWORD_SET_PASSWORD_LINK_TITLE'),
