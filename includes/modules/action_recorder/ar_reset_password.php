	...
	*/
	...
	class ar_reset_password {
		...
		function ar_reset_password() {
			global $osC_Language;
			$this->title = $osC_Language->get('MODULE_ACTION_RECORDER_RESET_PASSWORD_TITLE');
			$this->description = $osC_Language->get('MODULE_ACTION_RECORDER_RESET_PASSWORD_DESCRIPTION');
