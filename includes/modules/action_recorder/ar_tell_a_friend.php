	...
	*/
	...
	class ar_tell_a_friend {
		...
		function ar_tell_a_friend() {
			global $osC_Language;
			$this->title = $osC_Language->get('MODULE_ACTION_RECORDER_TELL_A_FRIEND_TITLE');
			$this->description = $osC_Language->get('MODULE_ACTION_RECORDER_TELL_A_FRIEND_DESCRIPTION');
