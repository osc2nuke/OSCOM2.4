	...
	<div class="thumbnail equal-height">
		...
		<div class="caption">
			...
			<div class="text-center">
				<div class="btn-group">
					<a href="<?php echo OSCOM::link('product_info.php', tep_get_all_get_params(array('action')) . 'products_id=' . $Qnew->valueInt('products_id')); ?>" class="btn btn-default" role="button"><?php echo $osC_Language->get('SMALL_IMAGE_BUTTON_VIEW'); ?></a>
					<a href="<?php echo OSCOM::link($PHP_SELF, tep_get_all_get_params(array('action')) . 'action=buy_now&products_id=' . $Qnew->valueInt('products_id')); ?>" class="btn btn-success" role="button"><?php echo $osC_Language->get('SMALL_IMAGE_BUTTON_BUY'); ?></a>
				</div>
			</div>
		</div>
	</div>
