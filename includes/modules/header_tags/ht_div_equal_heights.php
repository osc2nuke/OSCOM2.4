	...
	*/
	...
	class ht_div_equal_heights {
		...
		function ht_div_equal_heights() {
			global $osC_Language;
			$this->title = $osC_Language->get('MODULE_HEADER_TAGS_DIV_EQUAL_HEIGHTS_TITLE');
			$this->description = $osC_Language->get('MODULE_HEADER_TAGS_DIV_EQUAL_HEIGHTS_DESCRIPTION');
