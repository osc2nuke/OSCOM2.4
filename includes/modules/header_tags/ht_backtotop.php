	...
	*/
	...
	class ht_backtotop {
		...
		function ht_backtotop() {
			global $osC_Language;
			$this->title = $osC_Language->get('MODULE_HEADER_TAGS_BACKTOTOP_TITLE');
			$this->description = $osC_Language->get('MODULE_HEADER_TAGS_BACKTOTOP_DESCRIPTION');
		...
		function execute() {
			...
			$oscTemplate->addBlock('<a id="back-to-top" href="#" class="btn btn-primary btn-lg back-to-top" role="button" title="' . $osC_Language->get('MODULE_HEADER_TAGS_BACKTOTOP_LINK') . '" data-toggle="tooltip" data-placement="left"><span class="glyphicon glyphicon-chevron-up"></span></a>',  $this->group);
		}
