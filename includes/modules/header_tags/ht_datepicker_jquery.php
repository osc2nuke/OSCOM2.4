	...
	*/
	...
	class ht_datepicker_jquery {
		...
		function ht_datepicker_jquery() {
			global $osC_Language;
			$this->title = $osC_Language->get('MODULE_HEADER_TAGS_DATEPICKER_JQUERY_TITLE');
			$this->description = $osC_Language->get('MODULE_HEADER_TAGS_DATEPICKER_JQUERY_DESCRIPTION');
