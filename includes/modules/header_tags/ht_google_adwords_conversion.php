	...
	*/
	...
	class ht_google_adwords_conversion {
		...
		function ht_google_adwords_conversion() {
			global $osC_Language;
			$this->title = $osC_Language->get('MODULE_HEADER_TAGS_GOOGLE_ADWORDS_CONVERSION_TITLE');
			$this->description = $osC_Language->get('MODULE_HEADER_TAGS_GOOGLE_ADWORDS_CONVERSION_DESCRIPTION');
		...
		function execute() {
			global $PHP_SELF, $lng, $osC_Language, $oscTemplate;
