	...
	*/
	...
	class ht_google_analytics {
		...
		function ht_google_analytics() {
			global $osC_Language;
			$this->title = $osC_Language->get('MODULE_HEADER_TAGS_GOOGLE_ANALYTICS_TITLE');
			$this->description = $osC_Language->get('MODULE_HEADER_TAGS_GOOGLE_ANALYTICS_DESCRIPTION');
