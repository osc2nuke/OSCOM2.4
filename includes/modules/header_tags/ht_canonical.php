	...
	*/
	...
	class ht_canonical {
		...
		function ht_canonical() {
			global $osC_Language;
			$this->title = $osC_Language->get('MODULE_HEADER_TAGS_CANONICAL_TITLE');
			$this->description = $osC_Language->get('MODULE_HEADER_TAGS_CANONICAL_DESCRIPTION');
		...
		function execute() {
			global $PHP_SELF, $cPath, $osC_Language, $oscTemplate;
