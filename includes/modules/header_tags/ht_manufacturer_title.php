	...
	*/
	...
	class ht_manufacturer_title {
		...
		function ht_manufacturer_title() {
			global $osC_Language;
			$this->title = $osC_Language->get('MODULE_HEADER_TAGS_MANUFACTURER_TITLE_TITLE');
			$this->description = $osC_Language->get('MODULE_HEADER_TAGS_MANUFACTURER_TITLE_DESCRIPTION');
