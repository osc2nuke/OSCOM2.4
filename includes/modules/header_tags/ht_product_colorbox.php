	...
	*/
	...
	class ht_product_colorbox {
		...
		function ht_product_colorbox() {
			global $osC_Language;
			$this->title = $osC_Language->get('MODULE_HEADER_TAGS_PRODUCT_COLORBOX_TITLE');
			$this->description = $osC_Language->get('MODULE_HEADER_TAGS_PRODUCT_COLORBOX_DESCRIPTION');
