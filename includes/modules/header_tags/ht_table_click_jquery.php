	...
	*/
	...
	class ht_table_click_jquery {
		...
		function ht_table_click_jquery() {
			global $osC_Language;
			$this->title = $osC_Language->get('MODULE_HEADER_TAGS_TABLE_CLICK_JQUERY_TITLE');
			$this->description = $osC_Language->get('MODULE_HEADER_TAGS_TABLE_CLICK_JQUERY_DESCRIPTION');
