	...
	*/
	...
	class bm_shopping_cart {
		...
		function bm_shopping_cart() {
			global $osC_Language;
			$this->title = $osC_Language->get('MODULE_BOXES_SHOPPING_CART_TITLE');
			$this->description = $osC_Language->get('MODULE_BOXES_SHOPPING_CART_DESCRIPTION');
		...
		function execute() {
			global $new_products_id_in_cart, $currencies, $osC_Language, $oscTemplate;
			...
			if ($_SESSION['cart']->count_contents() > 0) {
				...
				$cart_contents_string .= '<p>' . $osC_Language->get('MODULE_BOXES_SHOPPING_CART_BOX_CART_EMPTY') . '</p>';
