	...
	*/
	...
	class bm_best_sellers {
		...
		function bm_best_sellers() {
			global $osC_Language;
			$this->title = $osC_Language->get('MODULE_BOXES_BEST_SELLERS_TITLE');
			$this->description = $osC_Language->get('MODULE_BOXES_BEST_SELLERS_DESCRIPTION');
		...
		function execute() {
			global $current_category_id, $osC_Language, $oscTemplate;
			...
			if (!isset($_GET['products_id'])) {
				...
				$Qbest->bindInt(':language_id', $osC_Language->getID());
