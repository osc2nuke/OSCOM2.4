	...
	*/
	...
	class bm_currencies {
		...
		function bm_currencies() {
			global $osC_Language;
			$this->title = $osC_Language->get('MODULE_BOXES_CURRENCIES_TITLE');
			$this->description = $osC_Language->get('MODULE_BOXES_CURRENCIES_DESCRIPTION');
		...
		function execute() {
			global $PHP_SELF, $currencies, $request_type, $osC_Language, $oscTemplate;
