	...
	*/
	...
	class bm_languages {
		...
		function bm_languages() {
			global $osC_Language;
			$this->title = $osC_Language->get('MODULE_BOXES_LANGUAGES_TITLE');
			$this->description = $osC_Language->get('MODULE_BOXES_LANGUAGES_DESCRIPTION');
		...
		function execute() {
			global $PHP_SELF, $lng, $request_type, $osC_Language, $oscTemplate;
