	...
	*/
	...
	class bm_categories {
		...
		function bm_categories() {
			global $osC_Language;
			$this->title = $osC_Language->get('MODULE_BOXES_CATEGORIES_TITLE');
			$this->description = $osC_Language->get('MODULE_BOXES_CATEGORIES_DESCRIPTION');
		...
		function execute() {
			global  $cPath, $osC_Language, $oscTemplate;
