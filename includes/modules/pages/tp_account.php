	...
	*/
	...
	class tp_account {
		...
		function prepare() {
			...
			'account' => array('title' => $osC_Language->get('MY_ACCOUNT_TITLE'),
			'links' => array('edit' => array('title' => $osC_Language->get('MY_ACCOUNT_INFORMATION'),
			'link' => OSCOM::link('account_edit.php', '', 'SSL'),
			'style' => 'btn btn-info',
			'icon' => 'fa fa-user fa-4x'),
			
			'address_book' => array('title' => $osC_Language->get('MY_ACCOUNT_ADDRESS_BOOK'),
			'link' => OSCOM::link('address_book.php', '', 'SSL'),
			'style' => 'btn btn-info',
			'icon' => 'fa fa-home fa-4x'),
			
			'password' => array('title' => $osC_Language->get('MY_ACCOUNT_PASSWORD'),
			'link' => OSCOM::link('account_password.php', '', 'SSL'),
			'style' => 'btn btn-info',
			'icon' => 'fa fa-cog fa-4x'))),
			
			'orders' => array('title' => $osC_Language->get('MY_ORDERS_TITLE'),
			
			'links' => array('history' => array('title' => $osC_Language->get('MY_ORDERS_VIEW'),
			'link' => OSCOM::link('account_history.php', '', 'SSL'),
			'style' => 'btn btn-info',
			'icon' => 'fa fa-shopping-cart fa-4x'))),
			
			'notifications' => array('title' => $osC_Language->get('EMAIL_NOTIFICATIONS_TITLE'),
			
			'links' => array('newsletters' => array('title' => $osC_Language->get('EMAIL_NOTIFICATIONS_NEWSLETTERS'),
			'link' => OSCOM::link('account_newsletters.php', '', 'SSL'),
			'style' => 'btn btn-info',
			'icon' => 'fa fa-envelope fa-4x'),
			
			'products' => array('title' => $osC_Language->get('EMAIL_NOTIFICATIONS_PRODUCTS'),
			...
			'links' => array('history' => array('title' => $osC_Language->get('MY_ACCOUNT_LOGOFF'),
