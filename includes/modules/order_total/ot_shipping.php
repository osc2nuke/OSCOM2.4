	...
	*/
	...
	class ot_shipping {
		...
		function ot_shipping() {
			...
			$this->title = $osC_Language->get('MODULE_ORDER_TOTAL_SHIPPING_TITLE');
			$this->description = $osC_Language->get('MODULE_ORDER_TOTAL_SHIPPING_DESCRIPTION');
		...
		function process() {
			global $order, $currencies, $osC_Language;
			...
			if (MODULE_ORDER_TOTAL_SHIPPING_FREE_SHIPPING == 'true') {
				...
				if ( ($pass == true) && ( ($order->info['total'] - $order->info['shipping_cost']) >= MODULE_ORDER_TOTAL_SHIPPING_FREE_SHIPPING_OVER) ) {
					$order->info['shipping_method'] = $osC_Language->get('FREE_SHIPPING_TITLE');
