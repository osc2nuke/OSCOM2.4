<?php
	...
	*/
	...
	if (isset($_POST['action']) && ($_POST['action'] == 'process') && isset($_POST['formid']) && ($_POST['formid'] == $_SESSION['sessiontoken'])) {
		...
		$messageStack->add_session('account', $osC_Language->get('ACCOUNT_NOTIFICATIONS_SUCCESS_NOTIFICATIONS_UPDATED'), 'success');
		
		OSCOM::redirect('account.php', '', 'SSL');
	}
	
	$breadcrumb->add($osC_Language->get('ACCOUNT_NOTIFICATIONS_NAVBAR_TITLE_1'), OSCOM::link('account.php', '', 'SSL'));
	$breadcrumb->add($osC_Language->get('ACCOUNT_NOTIFICATIONS_NAVBAR_TITLE_2'), OSCOM::link('account_notifications.php', '', 'SSL'));
	
	require('includes/template_top.php');
?>

<div class="page-header">
	<h1><?php echo $osC_Language->get('ACCOUNT_NOTIFICATIONS_HEADING_TITLE'); ?></h1>
</div>
...
<div class="contentContainer">
	<div class="alert alert-info">
		<?php echo $osC_Language->get('ACCOUNT_NOTIFICATIONS_MY_NOTIFICATIONS_DESCRIPTION'); ?>
	</div>
	
	<div class="contentText">
		<div class="form-group">
			<label class="control-label col-sm-4"><?php echo $osC_Language->get('ACCOUNT_NOTIFICATIONS_GLOBAL_NOTIFICATIONS_TITLE'); ?></label>
			<div class="col-sm-8">
				<div class="checkbox">
					<label>
						<?php echo HTML::checkboxField('product_global', '1', (($Qglobal->valueInt('global_product_notifications') === 1) ? true : false)); ?>
						<?php if (tep_not_null($osC_Language->get('ACCOUNT_NOTIFICATIONS_GLOBAL_NOTIFICATIONS_DESCRIPTION'))) echo ' ' . $osC_Language->get('ACCOUNT_NOTIFICATIONS_GLOBAL_NOTIFICATIONS_DESCRIPTION'); ?>
					</label>
				</div>
			</div>
		</div>
	...
	<?php
		...
		<div class="contentText">
			...
			<?php
				...
				<div class="alert alert-warning"><?php echo $osC_Language->get('ACCOUNT_NOTIFICATIONS_NOTIFICATIONS_DESCRIPTION'); ?></div>
				
				<div class="contentText">
					<div class="form-group">
						<label class="control-label col-sm-4"><?php echo $osC_Language->get('ACCOUNT_NOTIFICATIONS_MY_NOTIFICATIONS_TITLE'); ?></label>
						<div class="col-sm-8">
				...
				<div class="alert alert-warning">
					<?php echo $osC_Language->get('ACCOUNT_NOTIFICATIONS_NOTIFICATIONS_NON_EXISTING'); ?>
				</div>
