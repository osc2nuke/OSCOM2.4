<?php
	...
	*/
	...
	$breadcrumb->add($osC_Language->get('PRODUCT_REVIEWS_NAVBAR_TITLE'), OSCOM::link('product_reviews.php', tep_get_all_get_params()));
	...
	<div class="contentContainer">
		...
		<div class="row">
			<?php
				...
				$Qa->bindInt(':languages_id', $osC_Language->getID());
				...
				echo    sprintf($osC_Language->get('REVIEWS_TEXT_AVERAGE'), $Qa->valueInt('count'), HTML::stars(round($Qa->value('average'))));
				echo '</div>';
			?>
		...
		<?php
			...
			if ($Qreviews->getPageSetTotalRows() > 0) {
				...
				<div class="row">
					<div class="col-sm-6 pagenumber hidden-xs">
						<?php echo $Qreviews->getPageSetLabel($osC_Language->get('PRODUCT_REVIEWS_TEXT_DISPLAY_NUMBER_OF_REVIEWS')); ?>
					</div>
					<div class="col-sm-6">
						<div class="pull-right pagenav"><?php echo $Qreviews->getPageSetLinks(tep_get_all_get_params(array('page', 'info'))); ?></div>
						<span class="pull-right"><?php echo $osC_Language->get('PRODUCT_REVIEWS_TEXT_RESULT_PAGE'); ?></span>
					</div>
				</div>
					...
					<blockquote class="col-sm-6" itemprop="review" itemscope itemtype="http://schema.org/Review">
						...
						<footer>
							<?php
								...
								echo sprintf($osC_Language->get('REVIEWS_TEXT_RATED'), HTML::stars($Qreviews->value('reviews_rating')), $review_name, $review_name);
							?>
						</footer>
					</blockquote>
			...
			<?php
				...
				<div class="row">
					<div class="col-sm-6 pagenumber hidden-xs">
						<?php echo $Qreviews->getPageSetLabel($osC_Language->get('TEXT_DISPLAY_NUMBER_OF_REVIEWS')); ?>
					</div>
					<div class="col-sm-6">
						<div class="pull-right pagenav"><?php echo $Qreviews->getPageSetLinks(tep_get_all_get_params(array('page', 'info'))); ?></div>
			...
			<div class="contentText">
				<div class="alert alert-info">
					<?php echo $osC_Language->get('TEXT_NO_REVIEWS'); ?>
				</div>
			</div>
		...
		<div class="row">
			<div class="col-sm-6 text-right pull-right"><?php echo HTML::button($osC_Language->get('IMAGE_BUTTON_WRITE_REVIEW'), 'glyphicon glyphicon-comment', OSCOM::link('product_reviews_write.php', tep_get_all_get_params()), 'primary', null, 'btn-success'); ?></div>
			<div class="col-sm-6"><?php echo HTML::button($osC_Language->get('IMAGE_BUTTON_BACK'), 'glyphicon glyphicon-chevron-left', OSCOM::link('product_info.php', tep_get_all_get_params())); ?></div>
		</div>
	</div>
