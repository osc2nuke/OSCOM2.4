<?php
	...
	*/
	...
	$breadcrumb->add($osC_Language->get('REVIEWS_NAVBAR_TITLE'), OSCOM::link('reviews.php'));
	
	require('includes/template_top.php');
?>

<div class="page-header">
	<h1><?php echo $osC_Language->get('REVIEWS_HEADING_TITLE'); ?></h1>
</div>
				...
				<div class="col-sm-6 review">
					...
					<blockquote>
						...
						<footer>
							...
							echo sprintf($osC_Language->get('REVIEWS_TEXT_RATED'), HTML::stars($Qreviews->value('reviews_rating')), $review_name, $review_name) . '<a href="' . OSCOM::link('product_reviews.php', 'products_id=' . $Qreviews->valueInt('products_id')) . '"><span class="pull-right label label-info">' . $osC_Language->get('REVIEWS_REVIEWS_TEXT_READ_MORE') . '</span></a>'; ?>
						</footer>
					</blockquote>
				</div>
