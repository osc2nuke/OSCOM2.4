<?php
	...
	*/
	...
	$breadcrumb->add($osC_Language->get('CHECKOUT_SUCCESS_NAVBAR_TITLE_1'));
	$breadcrumb->add($osC_Language->get('CHECKOUT_SUCCESS_NAVBAR_TITLE_2'));
	
	require('includes/template_top.php');
?>

<div class="page-header">
	<h1><?php echo $osC_Language->get('CHECKOUT_SUCCESS_HEADING_TITLE'); ?></h1>
</div>
