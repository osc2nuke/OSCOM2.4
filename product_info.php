	...
	<div class="contentContainer">
		<div class="contentText">
			<div class="alert alert-warning">
				<?php echo $osC_Language->get('PRODUCT_INFO_TEXT_PRODUCT_NOT_FOUND'); ?>
			</div>
		</div>
		
		<div class="text-right">
			<?php echo HTML::button($osC_Language->get('IMAGE_BUTTON_CONTINUE'), 'glyphicon glyphicon-chevron-right', OSCOM::link('index.php'), null, null, 'btn-default btn-block'); ?>
		</div>
	</div>
		...
		<div class="contentContainer">
			<div class="contentText">
				...
				<?php
					...
					$Qpa->bindInt(':language_id', $osC_Language->getID());
					$Qpa->execute();
					...
					<div class="page-header">
						<h4><?php echo $osC_Language->get('PRODUCT_INFO_TEXT_PRODUCT_OPTIONS'); ?></h4>
					</div>
						...
						<div class="col-sm-6">
							<?php
								do {
									...
									$Qpo->bindInt(':language_id', $osC_Language->getID());
									$Qpo->execute();
				...
				<?php
					...
					<div class="alert alert-info"><?php echo sprintf($osC_Language->get('PRODUCT_INFO_TEXT_DATE_AVAILABLE'), tep_date_long($Qproduct->value('products_date_available'))); ?></div>
					...
					$Qr->bindInt(':languages_id', $osC_Language->getID());
					$Qr->execute();
				...
				<div class="row">
					<div class="col-sm-6 text-right pull-right"><?php echo HTML::hiddenField('products_id', $Qproduct->valueInt('products_id')) . HTML::button($osC_Language->get('IMAGE_BUTTON_IN_CART'), 'glyphicon glyphicon-shopping-cart', null, 'primary', null, 'btn-success'); ?></div>
					<div class="col-sm-6"><?php echo HTML::button($osC_Language->get('IMAGE_BUTTON_REVIEWS') . (($has_rating === true) ? ' (' . $Qr->value('count') . ')' : ''), 'glyphicon glyphicon-comment', OSCOM::link('product_reviews.php', tep_get_all_get_params())); ?></div>
				</div>
