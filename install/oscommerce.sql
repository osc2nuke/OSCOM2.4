...
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(1, 1, 'general', 'DATE_FORMAT_SHORT', '%m/%d/%Y');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(2, 1, 'general', 'DATE_FORMAT_LONG', '%A %d %B, %Y');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(3, 1, 'general', 'DATE_FORMAT', 'm/d/Y');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(4, 1, 'general', 'DATE_TIME_FORMAT', 'DATE_FORMAT_SHORT');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(5, 1, 'general', 'JQUERY_DATEPICKER_I18N_CODE', '');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(6, 1, 'general', 'JQUERY_DATEPICKER_FORMAT', 'mm/dd/yy');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(7, 1, 'general', 'LANGUAGE_CURRENCY', 'USD');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(8, 1, 'general', 'HTML_PARAMS', 'dir="ltr" lang="en"');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(9, 1, 'general', 'CHARSET', 'utf-8');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(10, 1, 'general', 'TITLE', 'STORE_NAME');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(11, 1, 'general', 'HEADER_TITLE_MY_ACCOUNT', 'My Account');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(12, 1, 'general', 'HEADER_TITLE_TOP', '<i class="glyphicon glyphicon-home"><span class="sr-only">Home</span></i>');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(13, 1, 'general', 'HEADER_TITLE_CATALOG', 'Catalog');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(14, 1, 'general', 'MALE', 'Male');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(15, 1, 'general', 'FEMALE', 'Female');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(16, 1, 'general', 'MALE_ADDRESS', 'Mr.');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(17, 1, 'general', 'FEMALE_ADDRESS', 'Ms.');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(18, 1, 'general', 'DOB_FORMAT_STRING', 'mm/dd/yyyy');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(19, 1, 'general', 'CHECKOUT_BAR_DELIVERY', 'Delivery Information');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(20, 1, 'general', 'CHECKOUT_BAR_PAYMENT', 'Payment Information');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(21, 1, 'general', 'CHECKOUT_BAR_CONFIRMATION', 'Confirmation');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(22, 1, 'general', 'CHECKOUT_BAR_FINISHED', 'Finished!');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(23, 1, 'general', 'PULL_DOWN_DEFAULT', 'Please Select');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(24, 1, 'general', 'JS_ERROR', 'Errors have occured during the process of your form.\\n\\nPlease make the following corrections:\\n\\n');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(25, 1, 'general', 'JS_REVIEW_TEXT', '* The \\''Review Text\\'' must have at least ');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(26, 1, 'general', 'JS_REVIEW_RATING', '* You must rate the product for your review.\\n');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(27, 1, 'general', 'JS_ERROR_NO_PAYMENT_MODULE_SELECTED', '* Please select a payment method for your order.\\n');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(28, 1, 'general', 'JS_ERROR_SUBMITTED', 'This form has already been submitted. Please press Ok and wait for this process to be completed.');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(29, 1, 'general', 'ERROR_NO_PAYMENT_MODULE_SELECTED', 'Please select a payment method for your order.');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(30, 1, 'general', 'CATEGORY_COMPANY', 'Company Details');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(31, 1, 'general', 'CATEGORY_PERSONAL', 'Your Personal Details');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(32, 1, 'general', 'CATEGORY_ADDRESS', 'Your Address');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(33, 1, 'general', 'CATEGORY_CONTACT', 'Your Contact Information');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(34, 1, 'general', 'CATEGORY_OPTIONS', 'Options');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(35, 1, 'general', 'CATEGORY_PASSWORD', 'Your Password');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(36, 1, 'general', 'ENTRY_COMPANY', 'Company Name');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(37, 1, 'general', 'ENTRY_COMPANY_TEXT', '');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(38, 1, 'general', 'ENTRY_GENDER', 'Gender');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(39, 1, 'general', 'ENTRY_GENDER_ERROR', 'Please select your Gender.');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(40, 1, 'general', 'ENTRY_GENDER_TEXT', '');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(41, 1, 'general', 'ENTRY_FIRST_NAME', 'First Name');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(42, 1, 'general', 'ENTRY_FIRST_NAME_ERROR', 'Your First Name must contain a minimum of ');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(43, 1, 'general', 'ENTRY_FIRST_NAME_TEXT', '');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(44, 1, 'general', 'ENTRY_LAST_NAME', 'Last Name');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(45, 1, 'general', 'ENTRY_LAST_NAME_ERROR', 'Your Last Name must contain a minimum of ');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(46, 1, 'general', 'ENTRY_LAST_NAME_TEXT', '');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(47, 1, 'general', 'ENTRY_DATE_OF_BIRTH', 'Date of Birth');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(48, 1, 'general', 'ENTRY_DATE_OF_BIRTH_ERROR', 'Your Date of Birth must be in this format: MM/DD/YYYY (eg 05/21/1970)');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(49, 1, 'general', 'ENTRY_DATE_OF_BIRTH_TEXT', '(eg. 05/21/1970)');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(50, 1, 'general', 'ENTRY_EMAIL_ADDRESS', 'E-Mail Address');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(51, 1, 'general', 'ENTRY_EMAIL_ADDRESS_ERROR', 'Your E-Mail Address does not appear to be formatted correctly.');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(52, 1, 'general', 'ENTRY_EMAIL_ADDRESS_CHECK_ERROR', 'Your E-Mail Address does not appear to be valid - please make any necessary corrections.');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(53, 1, 'general', 'ENTRY_EMAIL_ADDRESS_ERROR_EXISTS', 'Your E-Mail Address already exists in our records - please log in with the e-mail address or create an account with a different address.');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(54, 1, 'general', 'ENTRY_EMAIL_ADDRESS_TEXT', '');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(55, 1, 'general', 'ENTRY_STREET_ADDRESS', 'Street Address');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(56, 1, 'general', 'ENTRY_STREET_ADDRESS_ERROR', 'Your Street Address must contain a minimum of ');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(57, 1, 'general', 'ENTRY_STREET_ADDRESS_TEXT', '');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(58, 1, 'general', 'ENTRY_SUBURB', 'Suburb');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(59, 1, 'general', 'ENTRY_SUBURB_TEXT', '');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(60, 1, 'general', 'ENTRY_POST_CODE', 'Post Code');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(61, 1, 'general', 'ENTRY_POST_CODE_ERROR', 'Your Post Code must contain a minimum of ');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(62, 1, 'general', 'ENTRY_POST_CODE_TEXT', '');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(63, 1, 'general', 'ENTRY_CITY', 'City');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(64, 1, 'general', 'ENTRY_CITY_ERROR', 'Your City must contain a minimum of ');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(65, 1, 'general', 'ENTRY_CITY_TEXT', '');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(66, 1, 'general', 'ENTRY_STATE', 'State/Province');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(67, 1, 'general', 'ENTRY_STATE_ERROR', 'State does not appear to be formatted correctly.');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(68, 1, 'general', 'ENTRY_STATE_ERROR_SELECT', 'Please select a state from the States pull down menu.');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(69, 1, 'general', 'ENTRY_STATE_TEXT', '');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(70, 1, 'general', 'ENTRY_COUNTRY', 'Country');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(71, 1, 'general', 'ENTRY_COUNTRY_ERROR', 'You must select a country from the Countries pull down menu.');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(72, 1, 'general', 'ENTRY_COUNTRY_TEXT', '');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(73, 1, 'general', 'ENTRY_TELEPHONE_NUMBER', 'Telephone Number');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(74, 1, 'general', 'ENTRY_TELEPHONE_NUMBER_ERROR', 'Your Telephone Number must contain a minimum of ');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(75, 1, 'general', 'ENTRY_TELEPHONE_NUMBER_TEXT', '');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(76, 1, 'general', 'ENTRY_FAX_NUMBER', 'Fax Number');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(77, 1, 'general', 'ENTRY_FAX_NUMBER_TEXT', '');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(78, 1, 'general', 'ENTRY_NEWSLETTER', 'Newsletter');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(79, 1, 'general', 'ENTRY_NEWSLETTER_TEXT', '');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(80, 1, 'general', 'ENTRY_NEWSLETTER_YES', 'Subscribed');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(81, 1, 'general', 'ENTRY_NEWSLETTER_NO', 'Unsubscribed');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(82, 1, 'general', 'ENTRY_PASSWORD', 'Password');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(83, 1, 'general', 'ENTRY_PASSWORD_ERROR', 'Your Password must contain a minimum of ');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(84, 1, 'general', 'ENTRY_PASSWORD_ERROR_NOT_MATCHING', 'The Password Confirmation must match your Password.');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(85, 1, 'general', 'ENTRY_PASSWORD_TEXT', '');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(86, 1, 'general', 'ENTRY_PASSWORD_CONFIRMATION', 'Password Confirmation');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(87, 1, 'general', 'ENTRY_PASSWORD_CONFIRMATION_TEXT', '');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(88, 1, 'general', 'ENTRY_PASSWORD_CURRENT', 'Current Password');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(89, 1, 'general', 'ENTRY_PASSWORD_CURRENT_TEXT', '');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(90, 1, 'general', 'ENTRY_PASSWORD_CURRENT_ERROR', 'Your Password must contain a minimum of ');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(91, 1, 'general', 'ENTRY_PASSWORD_NEW', 'New Password');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(92, 1, 'general', 'ENTRY_PASSWORD_NEW_TEXT', '');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(93, 1, 'general', 'ENTRY_PASSWORD_NEW_ERROR', 'Your new Password must contain a minimum of ');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(94, 1, 'general', 'ENTRY_PASSWORD_NEW_ERROR_NOT_MATCHING', 'The Password Confirmation must match your new Password.');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(95, 1, 'general', 'ENTRY_PRICE_FROM_TEXT', '');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(96, 1, 'general', 'ENTRY_PRICE_TO_TEXT', '');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(97, 1, 'general', 'ENTRY_DATE_FROM_TEXT', '');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(98, 1, 'general', 'ENTRY_DATE_TO_TEXT', '');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(99, 1, 'general', 'ENTRY_COMMENTS_TEXT', '');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(100, 1, 'general', 'ENTRY_NAME_TEXT', '');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(101, 1, 'general', 'ENTRY_ENQUIRY_TEXT', '');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(102, 1, 'general', 'ENTRY_REVIEW_TEXT', '');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(103, 1, 'general', 'ENTRY_FORM_FIELD_CUSTOMER_NAME_TEXT', '');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(104, 1, 'general', 'ENTRY_FORM_FIELD_CUSTOMER_EMAIL_TEXT', '');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(105, 1, 'general', 'ENTRY_FORM_FIELD_FRIEND_NAME_TEXT', '');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(106, 1, 'general', 'ENTRY_FORM_FIELD_FRIEND_EMAIL_TEXT', '');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(107, 1, 'general', 'ENTRY_FORM_TITLE_FRIEND_MESSAGE_TEXT', '');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(108, 1, 'general', 'FORM_REQUIRED_INFORMATION', '<span class="glyphicon glyphicon-asterisk inputRequirement"></span> Required information');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(109, 1, 'general', 'TEXT_RESULT_PAGE', 'Result Pages:');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(110, 1, 'general', 'TEXT_DISPLAY_NUMBER_OF_PRODUCTS', 'Displaying <strong>%d</strong> to <strong>%d</strong> (of <strong>%d</strong> products)');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(111, 1, 'general', 'TEXT_DISPLAY_NUMBER_OF_ORDERS', 'Displaying <strong>%d</strong> to <strong>%d</strong> (of <strong>%d</strong> orders)');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(112, 1, 'general', 'TEXT_DISPLAY_NUMBER_OF_REVIEWS', 'Displaying <strong>%d</strong> to <strong>%d</strong> (of <strong>%d</strong> reviews)');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(113, 1, 'general', 'TEXT_DISPLAY_NUMBER_OF_PRODUCTS_NEW', 'Displaying <strong>%d</strong> to <strong>%d</strong> (of <strong>%d</strong> new products)');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(114, 1, 'general', 'TEXT_DISPLAY_NUMBER_OF_SPECIALS', 'Displaying <strong>%d</strong> to <strong>%d</strong> (of <strong>%d</strong> specials)');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(115, 1, 'general', 'PREVNEXT_TITLE_FIRST_PAGE', 'First Page');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(116, 1, 'general', 'PREVNEXT_TITLE_PREVIOUS_PAGE', 'Previous Page');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(117, 1, 'general', 'PREVNEXT_TITLE_NEXT_PAGE', 'Next Page');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(118, 1, 'general', 'PREVNEXT_TITLE_LAST_PAGE', 'Last Page');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(119, 1, 'general', 'PREVNEXT_TITLE_PAGE_NO', 'Page %d');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(120, 1, 'general', 'PREVNEXT_TITLE_PREV_SET_OF_NO_PAGE', 'Previous Set of %d Pages');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(121, 1, 'general', 'PREVNEXT_TITLE_NEXT_SET_OF_NO_PAGE', 'Next Set of %d Pages');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(122, 1, 'general', 'PREVNEXT_BUTTON_FIRST', '&lt;&lt;FIRST');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(123, 1, 'general', 'PREVNEXT_BUTTON_PREV', '[&lt;&lt;&nbsp;Prev]');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(124, 1, 'general', 'PREVNEXT_BUTTON_NEXT', '[Next&nbsp;&gt;&gt;]');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(125, 1, 'general', 'PREVNEXT_BUTTON_LAST', 'LAST&gt;&gt;');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(126, 1, 'general', 'IMAGE_BUTTON_ADD_ADDRESS', 'Add Address');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(127, 1, 'general', 'IMAGE_BUTTON_ADDRESS_BOOK', 'Address Book');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(128, 1, 'general', 'IMAGE_BUTTON_BACK', 'Back');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(129, 1, 'general', 'IMAGE_BUTTON_BUY_NOW', 'Buy Now');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(130, 1, 'general', 'IMAGE_BUTTON_CHANGE_ADDRESS', 'Change Address');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(131, 1, 'general', 'IMAGE_BUTTON_CHECKOUT', 'Checkout');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(132, 1, 'general', 'IMAGE_BUTTON_CONFIRM_ORDER', 'Confirm Order');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(133, 1, 'general', 'IMAGE_BUTTON_CONTINUE', 'Continue');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(134, 1, 'general', 'IMAGE_BUTTON_CONTINUE_SHOPPING', 'Continue Shopping');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(135, 1, 'general', 'IMAGE_BUTTON_DELETE', 'Delete');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(136, 1, 'general', 'IMAGE_BUTTON_EDIT_ACCOUNT', 'Edit Account');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(137, 1, 'general', 'IMAGE_BUTTON_HISTORY', 'Order History');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(138, 1, 'general', 'IMAGE_BUTTON_LOGIN', 'Sign In');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(139, 1, 'general', 'IMAGE_BUTTON_IN_CART', 'Add to Cart');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(140, 1, 'general', 'IMAGE_BUTTON_NOTIFICATIONS', 'Notifications');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(141, 1, 'general', 'IMAGE_BUTTON_PAY_TOTAL_NOW', 'Pay Now (%s)');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(142, 1, 'general', 'IMAGE_BUTTON_PAY_TOTAL_PROCESSING', 'Processing, please wait ..');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(143, 1, 'general', 'IMAGE_BUTTON_QUICK_FIND', 'Quick Find');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(144, 1, 'general', 'IMAGE_BUTTON_REMOVE_NOTIFICATIONS', 'Remove Notifications');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(145, 1, 'general', 'IMAGE_BUTTON_REVIEWS', 'Reviews');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(146, 1, 'general', 'IMAGE_BUTTON_SEARCH', 'Search');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(147, 1, 'general', 'IMAGE_BUTTON_SHIPPING_OPTIONS', 'Shipping Options');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(148, 1, 'general', 'IMAGE_BUTTON_TELL_A_FRIEND', 'Tell a Friend');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(149, 1, 'general', 'IMAGE_BUTTON_UPDATE', 'Update');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(150, 1, 'general', 'IMAGE_BUTTON_UPDATE_CART', 'Update Cart');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(151, 1, 'general', 'IMAGE_BUTTON_WRITE_REVIEW', 'Write Review');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(152, 1, 'general', 'SMALL_IMAGE_BUTTON_DELETE', 'Delete');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(153, 1, 'general', 'SMALL_IMAGE_BUTTON_EDIT', 'Edit');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(154, 1, 'general', 'SMALL_IMAGE_BUTTON_VIEW', 'View');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(155, 1, 'general', 'SMALL_IMAGE_BUTTON_BUY', 'Buy');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(156, 1, 'general', 'ICON_ARROW_RIGHT', 'more');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(157, 1, 'general', 'TEXT_GREETING_PERSONAL', 'Welcome back <span class="greetUser">%s!</span> Would you like to see which <a href="%s"><u>new products</u></a> are available to purchase?');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(158, 1, 'general', 'TEXT_GREETING_PERSONAL_RELOGON', '<small>If you are not %s, please <a href="%s"><u>log yourself in</u></a> with your account information.</small>');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(159, 1, 'general', 'TEXT_GREETING_GUEST', 'Welcome <span class="greetUser">Guest!</span> Would you like to <a href="%s"><u>log yourself in</u></a>? Or would you prefer to <a href="%s"><u>create an account</u></a>?');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(160, 1, 'general', 'TEXT_SORT_PRODUCTS', 'Sort products ');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(161, 1, 'general', 'TEXT_DESCENDINGLY', 'descendingly');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(162, 1, 'general', 'TEXT_ASCENDINGLY', 'ascendingly');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(163, 1, 'general', 'TEXT_BY', ' by ');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(164, 1, 'general', 'TEXT_REVIEW_BY', 'by %s');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(165, 1, 'general', 'TEXT_REVIEW_WORD_COUNT', '%s words');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(166, 1, 'general', 'TEXT_REVIEW_RATING', 'Rating: %s [%s]');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(167, 1, 'general', 'TEXT_REVIEW_DATE_ADDED', 'Date Added: %s');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(168, 1, 'general', 'TEXT_NO_REVIEWS', 'There are currently no product reviews.');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(169, 1, 'general', 'TEXT_UNKNOWN_TAX_RATE', 'Unknown tax rate');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(170, 1, 'general', 'TEXT_CCVAL_ERROR_INVALID_DATE', 'The expiry date entered for the credit card is invalid. Please check the date and try again.');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(171, 1, 'general', 'TEXT_CCVAL_ERROR_INVALID_NUMBER', 'The credit card number entered is invalid. Please check the number and try again.');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(172, 1, 'general', 'TEXT_CCVAL_ERROR_UNKNOWN_CARD', 'The first four digits of the number entered are: %s. If that number is correct, we do not accept that type of credit card. If it is wrong, please try again.');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(173, 1, 'general', 'FORM_REQUIRED_INPUT', '<span><span class="glyphicon glyphicon-asterisk form-control-feedback inputRequirement"></span></span>');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(174, 1, 'general', 'TEXT_SEARCH_PLACEHOLDER', 'Search Keywords...');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(175, 1, 'general', 'REVIEWS_TEXT_RATED', 'Rated %s by <span title="%s" itemprop="author" itemscope itemtype="http://schema.org/Person"><span itemprop="name">%s</span></span>');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(176, 1, 'general', 'REVIEWS_TEXT_AVERAGE', 'Average rating based on <span itemprop="ratingCount">%s</span> review(s) %s');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(177, 1, 'general', 'PRODUCT_SUBSCRIBED', '%s has been added to your Notification List');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(178, 1, 'general', 'PRODUCT_UNSUBSCRIBED', '%s has been removed from your Notification List');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(179, 1, 'general', 'PRODUCT_ADDED', '%s has been added to your Cart');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(180, 1, 'general', 'PRODUCT_REMOVED', '%s has been removed from your Cart');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(181, 1, 'general', 'TEXT_SORT_BY', 'Sort By ');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(182, 1, 'general', 'ACCOUNT_NAVBAR_TITLE', 'My Account');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(183, 1, 'general', 'ACCOUNT_HEADING_TITLE', 'My Account Information');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(184, 1, 'general', 'ACCOUNT_OVERVIEW_TITLE', 'Overview');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(185, 1, 'general', 'ACCOUNT_OVERVIEW_SHOW_ALL_ORDERS', '(show all orders)');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(186, 1, 'general', 'ACCOUNT_OVERVIEW_PREVIOUS_ORDERS', 'Previous Orders');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(187, 1, 'general', 'ACCOUNT_MY_ACCOUNT_TITLE', 'My Account');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(188, 1, 'general', 'ACCOUNT_MY_ACCOUNT_INFORMATION', 'View or change my account information.');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(189, 1, 'general', 'ACCOUNT_MY_ACCOUNT_ADDRESS_BOOK', 'View or change entries in my address book.');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(190, 1, 'general', 'ACCOUNT_MY_ACCOUNT_PASSWORD', 'Change my account password.');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(191, 1, 'general', 'ACCOUNT_MY_ORDERS_TITLE', 'My Orders');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(192, 1, 'general', 'ACCOUNT_MY_ORDERS_VIEW', 'View the orders I have made.');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(193, 1, 'general', 'ACCOUNT_EMAIL_NOTIFICATIONS_TITLE', 'E-Mail Notifications');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(194, 1, 'general', 'ACCOUNT_EMAIL_NOTIFICATIONS_NEWSLETTERS', 'Subscribe or unsubscribe from newsletters.');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(195, 1, 'general', 'ACCOUNT_EMAIL_NOTIFICATIONS_PRODUCTS', 'View or change my product notification list.');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(196, 1, 'general', 'ACCOUNT_MY_ACCOUNT_LOGOFF', 'Securely Log Out');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(197, 1, 'general', 'ACCOUNT_EDIT_NAVBAR_TITLE_1', 'My Account');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(198, 1, 'general', 'ACCOUNT_EDIT_NAVBAR_TITLE_2', 'Edit Account');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(199, 1, 'general', 'ACCOUNT_EDIT_HEADING_TITLE', 'My Account Information');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(200, 1, 'general', 'ACCOUNT_EDIT_MY_ACCOUNT_TITLE', 'My Account');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(201, 1, 'general', 'ACCOUNT_EDIT_SUCCESS_ACCOUNT_UPDATED', 'Your account has been successfully updated.');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(202, 1, 'general', 'ACCOUNT_HISTORY_INFO_NAVBAR_TITLE_1', 'My Account');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(203, 1, 'general', 'ACCOUNT_HISTORY_INFO_NAVBAR_TITLE_2', 'History');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(204, 1, 'general', 'ACCOUNT_HISTORY_INFO_NAVBAR_TITLE_3', 'Order #%s');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(205, 1, 'general', 'ACCOUNT_HISTORY_INFO_HEADING_TITLE', 'Order Information');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(206, 1, 'general', 'ACCOUNT_HISTORY_INFO_HEADING_ORDER_NUMBER', 'Order #%s');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(207, 1, 'general', 'ACCOUNT_HISTORY_INFO_HEADING_ORDER_DATE', 'Order Date');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(208, 1, 'general', 'ACCOUNT_HISTORY_INFO_HEADING_ORDER_TOTAL', 'Order Total');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(209, 1, 'general', 'ACCOUNT_HISTORY_INFO_HEADING_DELIVERY_ADDRESS', 'Delivery Address');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(210, 1, 'general', 'ACCOUNT_HISTORY_INFO_HEADING_SHIPPING_METHOD', 'Shipping Method');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(211, 1, 'general', 'ACCOUNT_HISTORY_INFO_HEADING_PRODUCTS', 'Products');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(212, 1, 'general', 'ACCOUNT_HISTORY_INFO_HEADING_TAX', 'Tax');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(213, 1, 'general', 'ACCOUNT_HISTORY_INFO_HEADING_TOTAL', 'Total');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(214, 1, 'general', 'ACCOUNT_HISTORY_INFO_HEADING_BILLING_INFORMATION', 'Billing Information');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(215, 1, 'general', 'ACCOUNT_HISTORY_INFO_HEADING_BILLING_ADDRESS', 'Billing Address');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(216, 1, 'general', 'ACCOUNT_HISTORY_INFO_HEADING_PAYMENT_METHOD', 'Payment Method');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(217, 1, 'general', 'ACCOUNT_HISTORY_INFO_HEADING_ORDER_HISTORY', 'Order History');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(218, 1, 'general', 'ACCOUNT_HISTORY_INFO_HEADING_COMMENT', 'Comments');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(219, 1, 'general', 'ACCOUNT_HISTORY_INFO_TEXT_NO_COMMENTS_AVAILABLE', 'No comments available.');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(220, 1, 'general', 'ACCOUNT_HISTORY_INFO_TABLE_HEADING_DOWNLOAD_DATE', 'Link expires: ');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(221, 1, 'general', 'ACCOUNT_HISTORY_INFO_TABLE_HEADING_DOWNLOAD_COUNT', ' downloads remaining');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(222, 1, 'general', 'ACCOUNT_HISTORY_INFO_HEADING_DOWNLOAD', 'Download links');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(223, 1, 'general', 'ACCOUNT_HISTORY_INFO_TEXT_NO_COMMENTS', 'There are no comments for this status.');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(224, 1, 'general', 'ACCOUNT_NEWSLETTERS_NAVBAR_TITLE_1', 'My Account');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(225, 1, 'general', 'ACCOUNT_NEWSLETTERS_NAVBAR_TITLE_2', 'Newsletter Subscriptions');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(226, 1, 'general', 'ACCOUNT_NEWSLETTERS_HEADING_TITLE', 'Newsletter Subscriptions');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(227, 1, 'general', 'ACCOUNT_NEWSLETTERS_MY_NEWSLETTERS_TITLE', 'My Newsletter Subscriptions');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(228, 1, 'general', 'ACCOUNT_NEWSLETTERS_MY_NEWSLETTERS_GENERAL_NEWSLETTER', 'General Newsletter');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(229, 1, 'general', 'ACCOUNT_NEWSLETTERS_MY_NEWSLETTERS_GENERAL_NEWSLETTER_DESCRIPTION', 'Including store news, new products, special offers, and other promotional announcements.');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(230, 1, 'general', 'ACCOUNT_NEWSLETTERS_SUCCESS_NEWSLETTER_UPDATED', 'Your newsletter subscriptions have been successfully updated.');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(231, 1, 'general', 'ACCOUNT_NOTIFICATIONS_NAVBAR_TITLE_1', 'My Account');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(232, 1, 'general', 'ACCOUNT_NOTIFICATIONS_NAVBAR_TITLE_2', 'Product Notifications');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(233, 1, 'general', 'ACCOUNT_NOTIFICATIONS_HEADING_TITLE', 'Product Notifications');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(234, 1, 'general', 'ACCOUNT_NOTIFICATIONS_MY_NOTIFICATIONS_TITLE', 'My Product Notifications');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(235, 1, 'general', 'ACCOUNT_NOTIFICATIONS_MY_NOTIFICATIONS_DESCRIPTION', 'The product notification list allows you to stay up to date on products you find of interest.<br /><br />To be up to date on all product changes, select <strong>Global Product Notifications</strong>.');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(236, 1, 'general', 'ACCOUNT_NOTIFICATIONS_GLOBAL_NOTIFICATIONS_TITLE', 'Global Product Notifications');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(237, 1, 'general', 'ACCOUNT_NOTIFICATIONS_GLOBAL_NOTIFICATIONS_DESCRIPTION', 'Recieve notifications on all available products.');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(238, 1, 'general', 'ACCOUNT_NOTIFICATIONS_NOTIFICATIONS_TITLE', 'Product Notifications');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(239, 1, 'general', 'ACCOUNT_NOTIFICATIONS_NOTIFICATIONS_DESCRIPTION', 'To remove a product notification, clear the products checkbox and click on Continue.');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(240, 1, 'general', 'ACCOUNT_NOTIFICATIONS_NOTIFICATIONS_NON_EXISTING', 'There are currently no products marked to be notified on.<br /><br />To add products to your product notification list, click on the notification link available on the detailed product information page.');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(241, 1, 'general', 'ACCOUNT_NOTIFICATIONS_SUCCESS_NOTIFICATIONS_UPDATED', 'Your product notifications have been successfully updated.');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(242, 1, 'general', 'ACCOUNT_PASSWORD_NAVBAR_TITLE_1', 'My Account');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(243, 1, 'general', 'ACCOUNT_PASSWORD_NAVBAR_TITLE_2', 'Change Password');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(244, 1, 'general', 'ACCOUNT_PASSWORD_HEADING_TITLE', 'My Password');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(245, 1, 'general', 'ACCOUNT_PASSWORD_MY_PASSWORD_TITLE', 'My Password');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(246, 1, 'general', 'ACCOUNT_PASSWORD_SUCCESS_PASSWORD_UPDATED', 'Your password has been successfully updated.');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(247, 1, 'general', 'ACCOUNT_PASSWORD_ERROR_CURRENT_PASSWORD_NOT_MATCHING', 'Your Current Password did not match the password in our records. Please try again.');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(248, 1, 'general', 'ADDRESS_BOOK_NAVBAR_TITLE_1', 'My Account');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(249, 1, 'general', 'ADDRESS_BOOK_NAVBAR_TITLE_2', 'Address Book');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(250, 1, 'general', 'ADDRESS_BOOK_HEADING_TITLE', 'My Personal Address Book');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(251, 1, 'general', 'ADDRESS_BOOK_PRIMARY_ADDRESS_TITLE', 'Primary Address');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(252, 1, 'general', 'ADDRESS_BOOK_PRIMARY_ADDRESS_DESCRIPTION', 'This address is used as the pre-selected shipping and billing address for orders placed on this store.<br /><br />This address is also used as the base for product and service tax calculations.');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(253, 1, 'general', 'ADDRESS_BOOK_ADDRESS_BOOK_TITLE', 'Address Book Entries');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(254, 1, 'general', 'ADDRESS_BOOK_PRIMARY_ADDRESS', '(primary address)');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(255, 1, 'general', 'ADDRESS_BOOK_TEXT_MAXIMUM_ENTRIES', '<font color="#ff0000"><strong>NOTE:</strong></font> A maximum of %s address book entries allowed.');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(256, 1, 'general', 'ADDRESS_BOOK_PROCESS_NAVBAR_TITLE_1', 'My Account');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(257, 1, 'general', 'ADDRESS_BOOK_PROCESS_NAVBAR_TITLE_2', 'Address Book');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(258, 1, 'general', 'ADDRESS_BOOK_PROCESS_NAVBAR_TITLE_ADD_ENTRY', 'New Entry');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(259, 1, 'general', 'ADDRESS_BOOK_PROCESS_NAVBAR_TITLE_MODIFY_ENTRY', 'Update Entry');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(260, 1, 'general', 'ADDRESS_BOOK_PROCESS_NAVBAR_TITLE_DELETE_ENTRY', 'Delete Entry');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(261, 1, 'general', 'ADDRESS_BOOK_PROCESS_HEADING_TITLE_ADD_ENTRY', 'New Address Book Entry');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(262, 1, 'general', 'ADDRESS_BOOK_PROCESS_HEADING_TITLE_MODIFY_ENTRY', 'Update Address Book Entry');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(263, 1, 'general', 'ADDRESS_BOOK_PROCESS_HEADING_TITLE_DELETE_ENTRY', 'Delete Address Book Entry');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(264, 1, 'general', 'ADDRESS_BOOK_PROCESS_DELETE_ADDRESS_TITLE', 'Delete Address');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(265, 1, 'general', 'ADDRESS_BOOK_PROCESS_DELETE_ADDRESS_DESCRIPTION', 'Are you sure you would like to delete the selected address from your address book?');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(266, 1, 'general', 'ADDRESS_BOOK_PROCESS_NEW_ADDRESS_TITLE', 'New Address Book Entry');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(267, 1, 'general', 'ADDRESS_BOOK_PROCESS_SELECTED_ADDRESS', 'Selected Address');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(268, 1, 'general', 'ADDRESS_BOOK_PROCESS_SET_AS_PRIMARY', 'Set as primary address.');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(269, 1, 'general', 'ADDRESS_BOOK_PROCESS_SUCCESS_ADDRESS_BOOK_ENTRY_DELETED', 'The selected address has been successfully removed from your address book.');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(270, 1, 'general', 'ADDRESS_BOOK_PROCESS_SUCCESS_ADDRESS_BOOK_ENTRY_UPDATED', 'Your address book has been successfully updated.');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(271, 1, 'general', 'ADDRESS_BOOK_PROCESS_WARNING_PRIMARY_ADDRESS_DELETION', 'The primary address cannot be deleted. Please set another address as the primary address and try again.');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(272, 1, 'general', 'ADDRESS_BOOK_PROCESS_ERROR_NONEXISTING_ADDRESS_BOOK_ENTRY', 'The address book entry does not exist.');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(273, 1, 'general', 'ADDRESS_BOOK_PROCESS_ERROR_ADDRESS_BOOK_FULL', 'Your address book is full. Please delete an unneeded address to save a new one.');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(274, 1, 'general', 'ADDRESS_BOOK_PROCESS_EDIT_ADDRESS_TITLE', 'Edit Address');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(275, 1, 'general', 'ADDRESS_BOOK_PROCESS_EDIT_ADDRESS_DESCRIPTION', 'Edit the selected Address');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(276, 1, 'general', 'CHECKOUT_CONFIRMATION_NAVBAR_TITLE_1', 'Checkout');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(277, 1, 'general', 'CHECKOUT_CONFIRMATION_NAVBAR_TITLE_2', 'Confirmation');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(278, 1, 'general', 'CHECKOUT_CONFIRMATION_HEADING_TITLE', 'Order Confirmation');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(279, 1, 'general', 'CHECKOUT_CONFIRMATION_HEADING_SHIPPING_INFORMATION', 'Shipping Information');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(280, 1, 'general', 'CHECKOUT_CONFIRMATION_HEADING_DELIVERY_ADDRESS', 'Delivery Address');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(281, 1, 'general', 'CHECKOUT_CONFIRMATION_HEADING_SHIPPING_METHOD', 'Shipping Method');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(282, 1, 'general', 'CHECKOUT_CONFIRMATION_HEADING_PRODUCTS', 'Products');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(283, 1, 'general', 'CHECKOUT_CONFIRMATION_HEADING_TAX', 'Tax');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(284, 1, 'general', 'CHECKOUT_CONFIRMATION_HEADING_TOTAL', 'Total');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(285, 1, 'general', 'CHECKOUT_CONFIRMATION_HEADING_BILLING_INFORMATION', 'Billing Information');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(286, 1, 'general', 'CHECKOUT_CONFIRMATION_HEADING_BILLING_ADDRESS', 'Billing Address');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(287, 1, 'general', 'CHECKOUT_CONFIRMATION_HEADING_PAYMENT_METHOD', 'Payment Method');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(288, 1, 'general', 'CHECKOUT_CONFIRMATION_HEADING_PAYMENT_INFORMATION', 'Payment Information');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(289, 1, 'general', 'CHECKOUT_CONFIRMATION_HEADING_ORDER_COMMENTS', 'Comments About Your Order');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(290, 1, 'general', 'CHECKOUT_CONFIRMATION_TEXT_EDIT', 'Edit');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(291, 1, 'general', 'CHECKOUT_PAYMENT_NAVBAR_TITLE_1', 'Checkout');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(292, 1, 'general', 'CHECKOUT_PAYMENT_NAVBAR_TITLE_2', 'Payment Method');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(293, 1, 'general', 'CHECKOUT_PAYMENT_HEADING_TITLE', 'Payment Information');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(294, 1, 'general', 'CHECKOUT_PAYMENT_TABLE_HEADING_BILLING_ADDRESS', 'Billing Address');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(295, 1, 'general', 'CHECKOUT_PAYMENT_TEXT_SELECTED_BILLING_DESTINATION', 'Please choose from your address book where you would like the invoice to be sent to.');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(296, 1, 'general', 'CHECKOUT_PAYMENT_TITLE_BILLING_ADDRESS', 'Billing Address');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(297, 1, 'general', 'CHECKOUT_PAYMENT_TABLE_HEADING_PAYMENT_METHOD', 'Payment Method');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(298, 1, 'general', 'CHECKOUT_PAYMENT_TEXT_SELECT_PAYMENT_METHOD', 'Please select the preferred payment method to use on this order.');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(299, 1, 'general', 'CHECKOUT_PAYMENT_TITLE_PLEASE_SELECT', 'Please Select');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(300, 1, 'general', 'CHECKOUT_PAYMENT_TEXT_ENTER_PAYMENT_INFORMATION', 'This is currently the only payment method available to use on this order.');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(301, 1, 'general', 'CHECKOUT_PAYMENT_TABLE_HEADING_COMMENTS', 'Add Comments About Your Order');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(302, 1, 'general', 'CHECKOUT_PAYMENT_TITLE_CONTINUE_CHECKOUT_PROCEDURE', 'Continue Checkout Procedure');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(303, 1, 'general', 'CHECKOUT_PAYMENT_TEXT_CONTINUE_CHECKOUT_PROCEDURE', 'to confirm this order.');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(304, 1, 'general', 'CHECKOUT_PAYMENT_ADDRESS_NAVBAR_TITLE_1', 'Checkout');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(305, 1, 'general', 'CHECKOUT_PAYMENT_ADDRESS_NAVBAR_TITLE_2', 'Change Billing Address');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(306, 1, 'general', 'CHECKOUT_PAYMENT_ADDRESS_HEADING_TITLE', 'Payment Information');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(307, 1, 'general', 'CHECKOUT_PAYMENT_ADDRESS_TABLE_HEADING_PAYMENT_ADDRESS', 'Billing Address');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(308, 1, 'general', 'CHECKOUT_PAYMENT_ADDRESS_TEXT_SELECTED_PAYMENT_DESTINATION', 'This is the currently selected billing address where the invoice to this order will be delivered to.');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(309, 1, 'general', 'CHECKOUT_PAYMENT_ADDRESS_TITLE_PAYMENT_ADDRESS', 'Billing Address');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(310, 1, 'general', 'CHECKOUT_PAYMENT_ADDRESS_TABLE_HEADING_ADDRESS_BOOK_ENTRIES', 'Address Book Entries');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(311, 1, 'general', 'CHECKOUT_PAYMENT_ADDRESS_TEXT_SELECT_OTHER_PAYMENT_DESTINATION', 'Please select the preferred billing address if the invoice to this order is to be delivered elsewhere.');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(312, 1, 'general', 'CHECKOUT_PAYMENT_ADDRESS_TITLE_PLEASE_SELECT', 'Please Select');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(313, 1, 'general', 'CHECKOUT_PAYMENT_ADDRESS_TABLE_HEADING_NEW_PAYMENT_ADDRESS', 'New Billing Address');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(314, 1, 'general', 'CHECKOUT_PAYMENT_ADDRESS_TEXT_CREATE_NEW_PAYMENT_ADDRESS', 'Please use the following form to create a new billing address to use for this order.');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(315, 1, 'general', 'CHECKOUT_PAYMENT_ADDRESS_TITLE_CONTINUE_CHECKOUT_PROCEDURE', 'Continue Checkout Procedure');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(316, 1, 'general', 'CHECKOUT_PAYMENT_ADDRESS_TEXT_CONTINUE_CHECKOUT_PROCEDURE', 'to select the preferred payment method.');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(317, 1, 'general', 'CHECKOUT_PROCESS_EMAIL_TEXT_SUBJECT', 'Order Process');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(318, 1, 'general', 'CHECKOUT_PROCESS_EMAIL_TEXT_ORDER_NUMBER', 'Order Number');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(319, 1, 'general', 'CHECKOUT_PROCESS_EMAIL_TEXT_INVOICE_URL', 'Detailed Invoice');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(320, 1, 'general', 'CHECKOUT_PROCESS_EMAIL_TEXT_DATE_ORDERED', 'Date Ordered');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(321, 1, 'general', 'CHECKOUT_PROCESS_EMAIL_TEXT_PRODUCTS', 'Products');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(322, 1, 'general', 'CHECKOUT_PROCESS_EMAIL_TEXT_SUBTOTAL', 'Sub-Total');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(323, 1, 'general', 'CHECKOUT_PROCESS_EMAIL_TEXT_TAX', 'Tax');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(324, 1, 'general', 'CHECKOUT_PROCESS_EMAIL_TEXT_SHIPPING', 'Shipping');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(325, 1, 'general', 'CHECKOUT_PROCESS_EMAIL_TEXT_TOTAL', 'Total');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(326, 1, 'general', 'CHECKOUT_PROCESS_EMAIL_TEXT_DELIVERY_ADDRESS', 'Delivery Address');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(327, 1, 'general', 'CHECKOUT_PROCESS_EMAIL_TEXT_BILLING_ADDRESS', 'Billing Address');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(328, 1, 'general', 'CHECKOUT_PROCESS_EMAIL_TEXT_PAYMENT_METHOD', 'Payment Method');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(329, 1, 'general', 'CHECKOUT_PROCESS_EMAIL_SEPARATOR', '------------------------------------------------------');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(330, 1, 'general', 'CHECKOUT_PROCESS_TEXT_EMAIL_VIA', 'via');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(331, 1, 'general', 'CHECKOUT_SHIPPING_NAVBAR_TITLE_1', 'Checkout');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(332, 1, 'general', 'CHECKOUT_SHIPPING_NAVBAR_TITLE_2', 'Shipping Method');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(333, 1, 'general', 'CHECKOUT_SHIPPING_HEADING_TITLE', 'Delivery Information');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(334, 1, 'general', 'CHECKOUT_SHIPPING_TABLE_HEADING_SHIPPING_ADDRESS', 'Shipping Address');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(335, 1, 'general', 'CHECKOUT_SHIPPING_TEXT_CHOOSE_SHIPPING_DESTINATION', 'Please choose from your address book where you would like the items to be delivered to.');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(336, 1, 'general', 'CHECKOUT_SHIPPING_TITLE_SHIPPING_ADDRESS', 'Shipping Address');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(337, 1, 'general', 'CHECKOUT_SHIPPING_TABLE_HEADING_SHIPPING_METHOD', 'Shipping Method');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(338, 1, 'general', 'CHECKOUT_SHIPPING_TEXT_CHOOSE_SHIPPING_METHOD', 'Please select the preferred shipping method to use on this order.');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(339, 1, 'general', 'CHECKOUT_SHIPPING_TITLE_PLEASE_SELECT', 'Please Select');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(340, 1, 'general', 'CHECKOUT_SHIPPING_TEXT_ENTER_SHIPPING_INFORMATION', 'This is currently the only shipping method available to use on this order.');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(341, 1, 'general', 'CHECKOUT_SHIPPING_TABLE_HEADING_COMMENTS', 'Add Comments About Your Order');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(342, 1, 'general', 'CHECKOUT_SHIPPING_TITLE_CONTINUE_CHECKOUT_PROCEDURE', 'Continue Checkout Procedure');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(343, 1, 'general', 'CHECKOUT_SHIPPING_TEXT_CONTINUE_CHECKOUT_PROCEDURE', 'to select the preferred payment method.');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(344, 1, 'general', 'CHECKOUT_SHIPPING_ERROR_NO_SHIPPING_AVAILABLE_TO_SHIPPING_ADDRESS', 'Shipping is currently not available for the selected shipping address. Please select or create a new shipping address to use with your purchase.');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(345, 1, 'general', 'CHECKOUT_SHIPPING_ADDRESS_NAVBAR_TITLE_1', 'Checkout');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(346, 1, 'general', 'CHECKOUT_SHIPPING_ADDRESS_NAVBAR_TITLE_2', 'Change Shipping Address');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(347, 1, 'general', 'CHECKOUT_SHIPPING_ADDRESS_HEADING_TITLE', 'Delivery Information');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(348, 1, 'general', 'CHECKOUT_SHIPPING_ADDRESS_TABLE_HEADING_SHIPPING_ADDRESS', 'Shipping Address');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(349, 1, 'general', 'CHECKOUT_SHIPPING_ADDRESS_TEXT_SELECTED_SHIPPING_DESTINATION', 'This is the currently selected shipping address where the items in this order will be delivered to.');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(350, 1, 'general', 'CHECKOUT_SHIPPING_ADDRESS_TITLE_SHIPPING_ADDRESS', 'Shipping Address');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(351, 1, 'general', 'CHECKOUT_SHIPPING_ADDRESS_TABLE_HEADING_ADDRESS_BOOK_ENTRIES', 'Address Book Entries');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(352, 1, 'general', 'CHECKOUT_SHIPPING_ADDRESS_TEXT_SELECT_OTHER_SHIPPING_DESTINATION', 'Please select the preferred shipping address if the items in this order are to be delivered elsewhere.');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(353, 1, 'general', 'CHECKOUT_SHIPPING_ADDRESS_TITLE_PLEASE_SELECT', 'Please Select');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(354, 1, 'general', 'CHECKOUT_SHIPPING_ADDRESS_TABLE_HEADING_NEW_SHIPPING_ADDRESS', 'New Shipping Address');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(355, 1, 'general', 'CHECKOUT_SHIPPING_ADDRESS_TEXT_CREATE_NEW_SHIPPING_ADDRESS', 'Please use the following form to create a new shipping address to use for this order.');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(356, 1, 'general', 'CHECKOUT_SHIPPING_ADDRESS_TITLE_CONTINUE_CHECKOUT_PROCEDURE', 'Continue Checkout Procedure');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(357, 1, 'general', 'CHECKOUT_SHIPPING_ADDRESS_TEXT_CONTINUE_CHECKOUT_PROCEDURE', 'to select the preferred shipping method.');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(358, 1, 'general', 'CHECKOUT_SUCCESS_NAVBAR_TITLE_1', 'Checkout');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(359, 1, 'general', 'CHECKOUT_SUCCESS_NAVBAR_TITLE_2', 'Success');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(360, 1, 'general', 'CHECKOUT_SUCCESS_HEADING_TITLE', 'Your Order Has Been Processed!');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(361, 1, 'general', 'CHECKOUT_SUCCESS_TABLE_HEADING_COMMENTS', 'Enter a comment for the order processed');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(362, 1, 'general', 'CHECKOUT_SHIPPING_NAVBAR_TITLE_1', 'Checkout');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(363, 1, 'general', 'CHECKOUT_SHIPPING_NAVBAR_TITLE_2', 'Shipping Method');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(364, 1, 'general', 'CHECKOUT_SHIPPING_HEADING_TITLE', 'Delivery Information');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(365, 1, 'general', 'CHECKOUT_SHIPPING_TABLE_HEADING_SHIPPING_ADDRESS', 'Shipping Address');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(366, 1, 'general', 'CHECKOUT_SHIPPING_TEXT_CHOOSE_SHIPPING_DESTINATION', 'Please choose from your address book where you would like the items to be delivered to.');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(367, 1, 'general', 'CHECKOUT_SHIPPING_TITLE_SHIPPING_ADDRESS', 'Shipping Address');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(368, 1, 'general', 'CHECKOUT_SHIPPING_TABLE_HEADING_SHIPPING_METHOD', 'Shipping Method');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(369, 1, 'general', 'CHECKOUT_SHIPPING_TEXT_CHOOSE_SHIPPING_METHOD', 'Please select the preferred shipping method to use on this order.');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(370, 1, 'general', 'CHECKOUT_SHIPPING_TITLE_PLEASE_SELECT', 'Please Select');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(371, 1, 'general', 'CHECKOUT_SHIPPING_TEXT_ENTER_SHIPPING_INFORMATION', 'This is currently the only shipping method available to use on this order.');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(372, 1, 'general', 'CHECKOUT_SHIPPING_TABLE_HEADING_COMMENTS', 'Add Comments About Your Order');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(373, 1, 'general', 'CHECKOUT_SHIPPING_TITLE_CONTINUE_CHECKOUT_PROCEDURE', 'Continue Checkout Procedure');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(374, 1, 'general', 'CHECKOUT_SHIPPING_TEXT_CONTINUE_CHECKOUT_PROCEDURE', 'to select the preferred payment method.');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(375, 1, 'general', 'CHECKOUT_SHIPPING_ERROR_NO_SHIPPING_AVAILABLE_TO_SHIPPING_ADDRESS', 'Shipping is currently not available for the selected shipping address. Please select or create a new shipping address to use with your purchase.');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(376, 1, 'general', 'CHECKOUT_SHIPPING_ADDRESS_NAVBAR_TITLE_1', 'Checkout');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(377, 1, 'general', 'CHECKOUT_SHIPPING_ADDRESS_NAVBAR_TITLE_2', 'Change Shipping Address');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(378, 1, 'general', 'CHECKOUT_SHIPPING_ADDRESS_HEADING_TITLE', 'Delivery Information');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(379, 1, 'general', 'CHECKOUT_SHIPPING_ADDRESS_TABLE_HEADING_SHIPPING_ADDRESS', 'Shipping Address');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(380, 1, 'general', 'CHECKOUT_SHIPPING_ADDRESS_TEXT_SELECTED_SHIPPING_DESTINATION', 'This is the currently selected shipping address where the items in this order will be delivered to.');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(381, 1, 'general', 'CHECKOUT_SHIPPING_ADDRESS_TITLE_SHIPPING_ADDRESS', 'Shipping Address');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(382, 1, 'general', 'CHECKOUT_SHIPPING_ADDRESS_TABLE_HEADING_ADDRESS_BOOK_ENTRIES', 'Address Book Entries');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(383, 1, 'general', 'CHECKOUT_SHIPPING_ADDRESS_TEXT_SELECT_OTHER_SHIPPING_DESTINATION', 'Please select the preferred shipping address if the items in this order are to be delivered elsewhere.');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(384, 1, 'general', 'CHECKOUT_SHIPPING_ADDRESS_TITLE_PLEASE_SELECT', 'Please Select');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(385, 1, 'general', 'CHECKOUT_SHIPPING_ADDRESS_TABLE_HEADING_NEW_SHIPPING_ADDRESS', 'New Shipping Address');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(386, 1, 'general', 'CHECKOUT_SHIPPING_ADDRESS_TEXT_CREATE_NEW_SHIPPING_ADDRESS', 'Please use the following form to create a new shipping address to use for this order.');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(387, 1, 'general', 'CHECKOUT_SHIPPING_ADDRESS_TITLE_CONTINUE_CHECKOUT_PROCEDURE', 'Continue Checkout Procedure');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(388, 1, 'general', 'CHECKOUT_SHIPPING_ADDRESS_TEXT_CONTINUE_CHECKOUT_PROCEDURE', 'to select the preferred shipping method.');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(389, 1, 'general', 'CHECKOUT_SUCCESS_NAVBAR_TITLE_1', 'Checkout');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(390, 1, 'general', 'CHECKOUT_SUCCESS_NAVBAR_TITLE_2', 'Success');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(391, 1, 'general', 'CHECKOUT_SUCCESS_HEADING_TITLE', 'Your Order Has Been Processed!');
...
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(922, 1, 'general', 'ADVANCED_SEARCH_NAVBAR_TITLE_1', 'Advanced Search');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(923, 1, 'general', 'ADVANCED_SEARCH_NAVBAR_TITLE_2', 'Search Results');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(924, 1, 'general', 'ADVANCED_SEARCH_HEADING_TITLE_1', 'Advanced Search');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(925, 1, 'general', 'ADVANCED_SEARCH_HEADING_TITLE_2', 'Products meeting the search criteria');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(926, 1, 'general', 'ADVANCED_SEARCH_HEADING_SEARCH_CRITERIA', 'Search Criteria');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(927, 1, 'general', 'ADVANCED_SEARCH_TEXT_SEARCH_IN_DESCRIPTION', 'Search In Product Descriptions');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(928, 1, 'general', 'ADVANCED_SEARCH_ENTRY_CATEGORIES', 'Categories');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(929, 1, 'general', 'ADVANCED_SEARCH_ENTRY_INCLUDE_SUBCATEGORIES', 'Include Subcategories');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(930, 1, 'general', 'ADVANCED_SEARCH_ENTRY_MANUFACTURERS', 'Manufacturers');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(931, 1, 'general', 'ADVANCED_SEARCH_ENTRY_PRICE_FROM', 'Price From');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(932, 1, 'general', 'ADVANCED_SEARCH_ENTRY_PRICE_TO', 'Price To');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(933, 1, 'general', 'ADVANCED_SEARCH_ENTRY_DATE_FROM', 'Date From');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(934, 1, 'general', 'ADVANCED_SEARCH_ENTRY_DATE_TO', 'Date To');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(935, 1, 'general', 'ADVANCED_SEARCH_TEXT_SEARCH_HELP_LINK', '<u>Search Help</u> [?]');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(936, 1, 'general', 'ADVANCED_SEARCH_TEXT_ALL_CATEGORIES', 'All Categories');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(937, 1, 'general', 'ADVANCED_SEARCH_TEXT_ALL_MANUFACTURERS', 'All Manufacturers');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(938, 1, 'general', 'ADVANCED_SEARCH_HEADING_SEARCH_HELP', 'Search Help');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(939, 1, 'general', 'ADVANCED_SEARCH_TEXT_SEARCH_HELP', 'Keywords may be separated by AND and/or OR statements for greater control of the search results.<br /><br />For example, <u>Microsoft AND mouse</u> would generate a result set that contain both words. However, for <u>mouse OR keyboard</u>, the result set returned would contain both or either words.<br /><br />Exact matches can be searched for by enclosing keywords in double-quotes.<br /><br />For example, <u>"notebook computer"</u> would generate a result set which match the exact string.<br /><br />Brackets can be used for further control on the result set.<br /><br />For example, <u>Microsoft and (keyboard or mouse or "visual basic")</u>.');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(940, 1, 'general', 'ADVANCED_SEARCH_TEXT_CLOSE_WINDOW', '<u>Close Window</u> [x]');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(941, 1, 'general', 'ADVANCED_SEARCH_TABLE_HEADING_IMAGE', '');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(942, 1, 'general', 'ADVANCED_SEARCH_TABLE_HEADING_MODEL', 'Model');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(943, 1, 'general', 'ADVANCED_SEARCH_TABLE_HEADING_PRODUCTS', 'Product Name');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(944, 1, 'general', 'ADVANCED_SEARCH_TABLE_HEADING_MANUFACTURER', 'Manufacturer');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(945, 1, 'general', 'ADVANCED_SEARCH_TABLE_HEADING_QUANTITY', 'Quantity');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(946, 1, 'general', 'ADVANCED_SEARCH_TABLE_HEADING_PRICE', 'Price');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(947, 1, 'general', 'ADVANCED_SEARCH_TABLE_HEADING_WEIGHT', 'Weight');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(948, 1, 'general', 'ADVANCED_SEARCH_TABLE_HEADING_BUY_NOW', 'Buy Now');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(949, 1, 'general', 'ADVANCED_SEARCH_TEXT_NO_PRODUCTS', 'There is no product that matches the search criteria.');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(950, 1, 'general', 'ADVANCED_SEARCH_ERROR_AT_LEAST_ONE_INPUT', 'At least one of the fields in the search form must be entered.');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(951, 1, 'general', 'ADVANCED_SEARCH_ERROR_INVALID_FROM_DATE', 'Invalid From Date.');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(952, 1, 'general', 'ADVANCED_SEARCH_ERROR_INVALID_TO_DATE', 'Invalid To Date.');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(953, 1, 'general', 'ADVANCED_SEARCH_ERROR_TO_DATE_LESS_THAN_FROM_DATE', 'To Date must be greater than or equal to From Date.');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(954, 1, 'general', 'ADVANCED_SEARCH_ERROR_PRICE_FROM_MUST_BE_NUM', 'Price From must be a number.');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(955, 1, 'general', 'ADVANCED_SEARCH_ERROR_PRICE_TO_MUST_BE_NUM', 'Price To must be a number.');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(956, 1, 'general', 'ADVANCED_SEARCH_ERROR_PRICE_TO_LESS_THAN_PRICE_FROM', 'Price To must be greater than or equal to Price From.');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(957, 1, 'general', 'ADVANCED_SEARCH_ERROR_INVALID_KEYWORDS', 'Invalid keywords.');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(958, 1, 'general', 'ACCOUNT_HISTORY_NAVBAR_TITLE_1', 'My Account');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(959, 1, 'general', 'ACCOUNT_HISTORY_NAVBAR_TITLE_2', 'History');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(960, 1, 'general', 'ACCOUNT_HISTORY_HEADING_TITLE', 'My Order History');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(961, 1, 'general', 'ACCOUNT_HISTORY_TEXT_ORDER_NUMBER', 'Order Number');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(962, 1, 'general', 'ACCOUNT_HISTORY_TEXT_ORDER_STATUS', 'Order Status');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(963, 1, 'general', 'ACCOUNT_HISTORY_TEXT_ORDER_DATE', 'Order Date');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(964, 1, 'general', 'ACCOUNT_HISTORY_TEXT_ORDER_SHIPPED_TO', 'Shipped To');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(965, 1, 'general', 'ACCOUNT_HISTORY_TEXT_ORDER_BILLED_TO', 'Billed To');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(966, 1, 'general', 'ACCOUNT_HISTORY_TEXT_ORDER_PRODUCTS', 'Products');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(967, 1, 'general', 'ACCOUNT_HISTORY_TEXT_ORDER_COST', 'Order Cost');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(968, 1, 'general', 'ACCOUNT_HISTORY_TEXT_VIEW_ORDER', 'View Order');
INSERT INTO osc_languages_definitions (id, languages_id, content_group, definition_key, definition_value) VALUES(969, 1, 'general', 'ACCOUNT_HISTORY_TEXT_NO_PURCHASES', 'You have not yet made any purchases.');
