<?php
	...
	*/
	...
	$breadcrumb->add($osC_Language->get('SHOPPING_CART_NAVBAR_TITLE'), OSCOM::link('shopping_cart.php'));
	
	require('includes/template_top.php');
?>

<div class="page-header">
	<h1><?php echo $osC_Language->get('SHOPPING_CART_HEADING_TITLE'); ?></h1>
</div>
...
<?php
	...
	<div class="contentContainer">
		...
		<div class="contentText">
			...
			<p class="text-right"><strong><?php echo $osC_Language->get('SHOPPING_CART_SUB_TITLE_SUB_TOTAL'); ?> <?php echo $currencies->format($_SESSION['cart']->show_total()); ?></strong></p>
			...
			<?php
				if ($any_out_of_stock == 1) {
					...
					<div class="alert alert-warning"><?php echo $osC_Language->get('SHOPPING_CART_OUT_OF_STOCK_CAN_CHECKOUT'); ?></div>
					
					<?php
						} else {
					?>
					
					<div class="alert alert-danger"><?php echo $osC_Language->get('SHOPPING_CART_OUT_OF_STOCK_CANT_CHECKOUT'); ?></div>
		...
		<div class="text-right">
			<?php echo HTML::button($osC_Language->get('IMAGE_BUTTON_CHECKOUT'), 'glyphicon glyphicon-chevron-right', OSCOM::link('checkout_shipping.php', '', 'SSL'), 'primary', null, 'btn-success btn-block'); ?>
		</div>
...
<div class="alert alert-danger">
	<?php echo $osC_Language->get('SHOPPING_CART_TEXT_CART_EMPTY'); ?>
</div>

<p class="text-right"><?php echo HTML::button($osC_Language->get('IMAGE_BUTTON_CONTINUE'), 'glyphicon glyphicon-chevron-right', OSCOM::link('index.php'), 'primary', NULL, 'btn-danger'); ?></p>
