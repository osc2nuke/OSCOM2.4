<?php
	...
	*/
	...
	$breadcrumb->add($osC_Language->get('CHECKOUT_PAYMENT_ADDRESS_NAVBAR_TITLE_1'), OSCOM::link('checkout_payment.php', '', 'SSL'));
	$breadcrumb->add($osC_Language->get('CHECKOUT_PAYMENT_ADDRESS_NAVBAR_TITLE_2'), OSCOM::link('checkout_payment_address.php', '', 'SSL'));
...
<div class="page-header">
	<h1><?php echo $osC_Language->get('CHECKOUT_PAYMENT_ADDRESS_HEADING_TITLE'); ?></h1>
</div>
...
<div class="contentContainer">
	...
	<?php
		...
		<div class="page-header">
			<h4><?php echo $osC_Language->get('CHECKOUT_PAYMENT_ADDRESS_TABLE_HEADING_PAYMENT_ADDRESS'); ?></h4>
		</div>
		
		<div class="contentText row">
			<div class="col-sm-8">
				<div class="alert alert-warning">
					<?php echo $osC_Language->get('CHECKOUT_PAYMENT_ADDRESS_TEXT_SELECTED_PAYMENT_DESTINATION'); ?>
				</div>
			</div>
			<div class="col-sm-4">
				<div class="panel panel-primary">
					<div class="panel-heading"><?php echo $osC_Language->get('CHECKOUT_PAYMENT_ADDRESS_TITLE_PAYMENT_ADDRESS'); ?></div>
		...
		<?php
			...
			<div class="page-header">
				<h4><?php echo $osC_Language->get('CHECKOUT_PAYMENT_ADDRESS_TABLE_HEADING_ADDRESS_BOOK_ENTRIES'); ?></h4>
			</div>
			
			<div class="contentText">
				<div class="alert alert-warning">
					<div class="pull-right">
						<?php echo '<strong>' . $osC_Language->get('CHECKOUT_PAYMENT_ADDRESS_TITLE_PLEASE_SELECT') . '</strong>'; ?>
					</div>
					
					<?php echo $osC_Language->get('CHECKOUT_PAYMENT_ADDRESS_TEXT_SELECT_OTHER_PAYMENT_DESTINATION'); ?>
				</div>
			</div>
	...
	<div class="page-header">
		<h4><?php echo $osC_Language->get('CHECKOUT_PAYMENT_ADDRESS_TABLE_HEADING_NEW_PAYMENT_ADDRESS'); ?></h4>
	</div>
	
	<div class="contentText">
		<div class="alert alert-info">
			<?php echo $osC_Language->get('CHECKOUT_PAYMENT_ADDRESS_TEXT_CREATE_NEW_PAYMENT_ADDRESS'); ?>
		</div>
	</div>
...
<?php
	...
	<div>
		<?php echo HTML::button($osC_Language->get('IMAGE_BUTTON_BACK'), 'glyphicon glyphicon-chevron-left', OSCOM::link('checkout_payment_address.php', '', 'SSL')); ?>
	</div>
